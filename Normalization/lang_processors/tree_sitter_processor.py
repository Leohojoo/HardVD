...
#
from Normalization.lang_processors.lang_processor import LangProcessor
from Normalization.lang_processors.tokenization_utils import (
    process_string,
    replace_tokens,
    indent_lines,
)
...
class TreeSitterLangProcessor(LangProcessor):
    ...
    def create_treesiter_parser(self):
        if self.parser is None:
            lib_path = '/data/hjli/win_linux_mapping/multimodal_rerprogramming/Normalization/lang_processors/my-languages.so'
