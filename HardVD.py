...
train_hps = {  #设置默认参数值
    ...
    'validate_every' : 2322, # validates on small subset of val set       ours  2:105929  vulcnn 2:15551 vulcnn2 2:15986 devign 2:10927
    'evaluate_every' : 2322, # evaluates on full test set using best ckpt #d2a 4:1161 2:2322   reveal 4:4547 2:9094
...
def main():
    ...
    start_time = time.time()
    # #d2a
    code_train = pd.read_csv('./data/d2a/function/d2a_train.csv')
    text_train = pd.read_csv('./data/d2a/function/d2a_train_text.csv')
    code_val = pd.read_csv('./data/d2a/function/d2a_dev.csv')
    text_val = pd.read_csv('./data/d2a/function/d2a_dev_text.csv')
    ...
    #对抗重编程
    reprogrammer = HardVD_model.ReprogrammingFuntion(vocab_size, args.img_patch_size,
        args.img_size, 
    ...
    if n_classes < num_imagenet_labels:
        ...
        multi_label_remapper = HardVD_model.MultiLabelRemapper(num_imagenet_labels, n_classes)
